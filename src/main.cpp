...
int main(int, char**)
{
    ...
    world->setAmbient(Color(0.1, 0.7, 0.0));
    ...
    Material *reflectedMaterial = new Material(world);
    reflectedMaterial->color = Color(0.1, 0.7, 0.0);
    reflectedMaterial->ka = 0.1;
    ...
    dielectricMaterial->ka = 0.1;
    dielectricMaterial->ks = 0.4;
